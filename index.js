...
//
// - 📊 每日營運總覽（08:00 推播）
//   ・C1：三店營運摘要（業績 / 套餐數 / 客單 / 人事）
//   ・C2：各店銷售佔比（全品項顯示）
//
// 【C2 銷售佔比顯示規格（v1.6.2 定版）】
// ------------------------------------------------------
// - 全部品項顯示（不限制 top N）
// - 排序依各店銷量規則（資料層排序，顯示層不重排）
// - 湯棧中山採「上下雙區塊」：
//   ・上半段：鍋物（含聖誕）
//   ・下半段：冷藏肉
// - 「麻油、燒酒鍋」「冷藏肉比例」為彙總列：
...
// - C2 銷售佔比改為「雙區塊獨立排名」
//   ・鍋物 / 冷藏肉各自前三名顏色標示
// - 全品項顯示穩定化（JSON 結構已驗證不噴 400）
// - C1 + C2 合併單一 Carousel 推播（流檢同款行為）
// - 本版本起視為「營運報表顯示定版」
// ======================================================
