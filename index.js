...
// - 穩定：圖片翻譯 / 今日英文 共用解析器
// - 優化：TradingView Webhook 獨立優先路徑，不被群組訊息阻塞。
// - 優化：加入群組抗噪過濾器 (Shielding)，閒聊訊息不佔 CPU。
// - 保留：狀態保命線 (Stateful Line)，確保高鐵與圖片翻譯不中斷。
// ======================================================
...
      systemPrompt: TAIWAN_REWRITE_SYSTEM_PROWRITE_PROMPT,
      userPrompt: content,
      temperature
    });
  } catch (err) {
...
// ======================================================
// LINE Webhook（Router 主流程｜v1.7.1 抗噪防火牆架構）
// ======================================================
